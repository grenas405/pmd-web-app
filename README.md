...
- `typewriter.js` — the hero's two rotating lines: the slogan resolves out of scrambled characters,
  the tagline cross-fades through five languages carrying its `lang` with it (both first values are
  in the HTML)
